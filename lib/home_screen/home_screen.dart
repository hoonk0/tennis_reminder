...
import 'package:tennisreminder/home_screen/drawmenu/search_court/court_information.dart';
    ...
    return Scaffold(
      ...
      Column(
        ...
        children: [
          ...
          SizedBox(height: 10), // 텍스트와 그리드 사이의 간격
          Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TS.s12w400(colorGreen900),
                              ),
                            ],
                          ),
                        ),
